...
Module RTBBLibDll
    ...
    Public Declare Function RTBB_EXTGSOW_SendData Lib "RTBBLib.dll" (ByVal hDevice As Integer, ByVal nLength As UInteger, ByVal nMask As UInteger, ByRef pBuffer As Short, ByVal bCheckAck As Boolean) As Integer
    ...
    Public Declare Function RTBB_EXTGSMW_SendData Lib "RTBBLib.dll" (ByVal hDevice As Integer, ByVal nLength As UInteger, ByVal nMask As UInteger, ByRef pBuffer As Short, ByVal bCheckAck As Boolean) As Integer
    ...
    Public Declare Function RTBB_GetIsoBoardCount Lib "RTBBLib.dll" (ByVal hEnumIsoBoard As Integer) As Integer
    Public Declare Function RTBB_FreeEnumIsoBoard Lib "RTBBLib.dll" (ByVal hEnumIsoBoard As Integer) As Boolean
    Public Declare Function RTBB_DisconnectIso Lib "RTBBLib.dll" (ByVal hIsoDevice As Integer) As Boolean
    Public Declare Function RTBB_GetIsoBoardInfo Lib "RTBBLib.dll" (ByVal hIsoDevice As Integer) As Integer
    'Public Declare Function RTBB_ConnectToIsoBoardAsBridgeByIndex Lib "RTBBLib.dll" (ByVal hEnumIsoBoard As Integer, ByVal nIndex As Integer) As Integer





    Public Declare Function RTBB_EnumIsolatedBoard Lib "RTBBLib.dll" (ByVal pBoardNames As String(), ByVal nameCount As Integer) As Integer
    Public Declare Function RTBB_ConnectToIsoBoardByIndex Lib "RTBBLib.dll" (ByVal hEnumIsoBoard As Integer, ByVal nIndex As Integer) As Integer

    Public Declare Function RTBB_Iso_Transact Lib "RTBBLib.dll" (ByVal hIsoDevice As Integer,
    ...
    'Public Declare Function RTBB_Iso_Ping Lib "RTBBLib.dll" (ByVal hIsoDevice As Integer) As Boolean
