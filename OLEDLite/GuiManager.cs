...
namespace OLEDLite
{
    public partial class main
    {
        ...
        //    dg_swire.Columns[0].Width = 240;
        //    dg_swire.AllowUserToAddRows = false;
        //    dg_swire.RowCount = 1;

        //    Label lab_swire_num = new Label();
        //    lab_swire_num.Text = "Swire Row";
        //    lab_swire_num.Location = new System.Drawing.Point(280, base_offset * 3 + 5);
        //    lab_swire_num.Width = 70;
        //    inter_grop.Controls.Add(lab_swire_num);

        //    nu_swire_row.Location = new System.Drawing.Point(360, base_offset * 3);
