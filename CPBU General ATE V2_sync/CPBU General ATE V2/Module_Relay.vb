Module Module_Relay
        ...
        If buck_num = 3 Then
            ...
            For i = 1 To average
                ...
                For ii = 0 To 1
                    ...
                    temp = reg_read_word(Meas_ID, Meas_Addr)
    ...
    Function INA226_config() As Integer
        ...
        reg_write_word(Meas_VIN_P_ID, config_addr, data)
        reg_write_word(Meas_VIN_N_ID, config_addr, data)
        reg_write_word(Meas_BUCK1_CH1_ID, config_addr, data)
        reg_write_word(Meas_BUCK1_CH2_ID, config_addr, data)
        reg_write_word(Meas_BUCK2_CH1_ID, config_addr, data)
        reg_write_word(Meas_BUCK2_CH2_ID, config_addr, data)
    ...
    Function current_monitor_init() As Integer
        ...
        reg_write_word(Meas_VIN_P_ID, cal_addr, cal_value)
        ...
        cal_value = word2byte_data("H", value)
        reg_write_word(Meas_VIN_N_ID, cal_addr, cal_value)
        ...
        cal_value = word2byte_data("H", value)
        reg_write_word(Meas_BUCK1_CH1_ID, cal_addr, cal_value)
        reg_write_word(Meas_BUCK2_CH1_ID, cal_addr, cal_value)
        ...
        cal_value = word2byte_data("H", value)
        reg_write_word(Meas_BUCK1_CH2_ID, cal_addr, cal_value)
        reg_write_word(Meas_BUCK2_CH2_ID, cal_addr, cal_value)
    ...
    Function relay_init() As Integer
        ...
        For i = 0 To Relay_ID.Length - 1
            Relay_dat_A(i) = 0
            Relay_dat_B(i) = 0
            reg_write(Relay_ID(i), Relay_IODIRA, IODIR_OUT)
            reg_write(Relay_ID(i), Relay_IODIRB, IODIR_OUT)

            reg_write(Relay_ID(i), Relay_GPIOA, Relay_dat_A(i))
            reg_write(Relay_ID(i), Relay_GPIOB, Relay_dat_B(i))
    ...
    Function relay_function_set() As Integer
        ...
        relay_function_set = reg_write(Relay_ID(0), Relay_GPIOB, Relay_dat_B(0))
    ...
    Function relay_Scope_set() As Integer
        ...
        relay_Scope_set = reg_write(Relay_ID(0), Relay_GPIOA, Relay_dat_A(0))
